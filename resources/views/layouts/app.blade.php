...
<head>
    ...
    <title>@yield('title', 'Chookiat  - ระบบจัดการคลังรถและคำนวณค่างวด')</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm py-2">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center gap-2 text-white fw-bold" href="{{ route('dashboard') }}">
                    ...
                    <span>Dashboard <span class="text-primary"></span></span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarMain">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('installments.*') ? 'active' : '' }}"
