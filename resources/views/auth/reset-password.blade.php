                ...
                <form id="resetForm" method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control bg-light @error('email') is-invalid @enderror"
                                id="email" name="email" value="{{ old('email', $email) }}" readonly required>
                        </div>
                        @error('email')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                id="password" name="password" placeholder="อย่างน้อย 6 ตัวอักษร" required autofocus
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="password_confirmation"
                                name="password_confirmation" placeholder="กรอกรหัสผ่านใหม่อีกครั้ง" required
                                autocomplete="new-password">
                            <span class="input-group-text toggle-password" id="toggleConfirmPasswordBtn"
                    ...
                    <div class="d-grid mb-3">
                        <button type="submit" id="submitBtn"
                            class="btn btn-primary btn-reset d-flex align-items-center justify-content-center gap-2">
